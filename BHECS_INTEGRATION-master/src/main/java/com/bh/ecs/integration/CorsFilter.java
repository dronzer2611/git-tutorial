...
class CorsFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		response.setHeader("Access-Control-Allow-Headers", //$NON-NLS-1$
				"Origin,Accept,X-Requested-With,Content-Type,Access-Control-Request-Method,Access-Control-Request-Headers,Authorization,divBlobAuthentication"); //$NON-NLS-1$
